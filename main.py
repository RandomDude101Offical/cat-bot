...
async def run_spawn(ch_id=None):
    ...
    if ch_id:
        ...
        await bot.change_presence(
                activity=discord.CustomActivity(name=f"Being in {len(bot.guilds):,} servers with {total_members:,} cats", emoji=discord.PartialEmoji.from_str(get_emoji("staring_cat")))
        )
